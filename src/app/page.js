...
export default function InputComponent() {
  ...
  return (
    <div className="relative min-h-screen w-full overflow-auto">
      ...
      <div className="flex-grow flex p-6 pt-14 justify-center">
        <div className="w-full max-w-md text-black">
          ...
          {errorMessage && (
            <div className="text-red-300 mt-4 text-center">{errorMessage}</div>
          )}
      ...
      <div className="bottom-0 left-0 w-full flex justify-center pt-10 z-10">
        <img
          src="/ondotfooter.png"
          alt="Logo"
